    ...
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-10">
      <div className="flex gap-4">
        <button
          ...
          className={`flex-1 flex items-center justify-center gap-3 py-4 rounded-2xl border transition-all font-black text-xs tracking-widest uppercase ${
            method === 'upi' 
        ...
        <div className="space-y-2">
          ...
          <div className="relative group">
            ...
            <input
              ...
              className="w-full bg-white/5 border border-white/5 rounded-2xl p-4 pl-10 text-xl font-black focus:border-primary/50 outline-none"
              placeholder="Min 100"
            />
          </div>
              ...
              <div className="grid grid-cols-2 gap-6">
                <div className="space-y-2">
                  ...
                  <input
                    ...
                    className="w-full bg-white/5 border border-white/5 rounded-2xl p-4 text-sm font-bold focus:border-primary/50 outline-none uppercase"
