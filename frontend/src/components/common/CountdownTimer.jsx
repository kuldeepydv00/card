...
const CountdownTimer = ({ closeMinute = 50 }) => {
  ...
  return (
    <div className="flex flex-col gap-4 h-full">
      <div className="flex-1 glass-card p-6 rounded-[2rem] relative overflow-hidden group">
        ...
        <div className="flex flex-col">
          <p className={`text-4xl font-black font-mono tracking-tighter ${isClosed ? 'text-red-500' : 'text-white'}`}>
