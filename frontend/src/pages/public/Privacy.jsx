...
const Privacy = () => {
  return (
    <div className="min-h-screen bg-[#0a0f1c] text-white font-sans">
      <Helmet>
        <title>Privacy Policy | 50xcards</title>
        <meta name="description" content="Read the Privacy Policy for 50xcards. We take your security and data protection seriously." />
      </Helmet>
