...
const About = () => {
  return (
    <div className="min-h-screen bg-[#0a0f1c] text-white font-sans">
      <Helmet>
        <title>About Us | 50xcards</title>
        <meta name="description" content="Learn more about 50xcards, the best betting game in India and the ultimate card trading platform." />
      </Helmet>
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <h1 className="text-4xl md:text-5xl font-black mb-8">About 50xcards</h1>
