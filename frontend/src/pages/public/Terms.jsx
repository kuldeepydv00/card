...
const Terms = () => {
  return (
    <div className="min-h-screen bg-[#0a0f1c] text-white font-sans">
      <Helmet>
        <title>Terms of Service | 50xcards</title>
        <meta name="description" content="Read the Terms of Service for 50xcards, the premier card trading and online betting platform." />
      </Helmet>
