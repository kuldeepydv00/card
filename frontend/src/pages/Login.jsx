...
import { Mail, Lock, ArrowRight, ShieldCheck, Sparkles, KeyRound, Eye, EyeOff } from 'lucide-react';
...
const Login = () => {
  ...
  const submitOtp = async (otpString) => {
    ...
    setIsVerifying(true);
    try {
      await verifyLogin(loginData.email, loginData.password, otpString);
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 relative overflow-hidden bg-background">
      ...
      <div className="absolute bottom-[-10%] left-[-10%] w-[50%] h-[50%] bg-accent/15 blur-[150px] rounded-full animate-pulse" style={{ animationDelay: '2s' }} />
      <div className="absolute top-[40%] left-[20%] w-[30%] h-[30%] bg-secondary/20 blur-[120px] rounded-full" />
        ...
        <div className="glass-card rounded-[2.5rem] overflow-hidden flex flex-col md:flex-row relative shadow-[0_0_50px_rgba(99,102,241,0.1)] border border-white/10">
          ...
          <div className="hidden md:flex md:w-5/12 bg-gradient-to-br from-surface/80 to-background/90 p-10 flex-col justify-between border-r border-white/5 relative overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              >
                Log in to access your dashboard, manage your bets, and stay updated with the latest game results.
              </motion.p>
            </div>
            ...
            >
              <div className="p-5 bg-white/5 rounded-2xl border border-white/5 backdrop-blur-sm relative overflow-hidden group">
                <div className="absolute inset-0 bg-gradient-to-r from-transparent via-white/5 to-transparent translate-x-[-100%] group-hover:translate-x-[100%] transition-transform duration-1000" />
                <p className="text-[11px] text-primary uppercase tracking-widest font-bold mb-2 flex items-center gap-2">
                  <Sparkles size={12} />
                  Live Support
                </p>
            ...
            <AnimatePresence mode="wait">
              {step === 1 && (
                ...
                >
                  <div className="mb-10 text-center md:text-left">
                    <h1 className="text-3xl md:text-4xl font-extrabold mb-3 text-white tracking-tight">Sign In</h1>
                  ...
                  <div className="mt-10 pt-8 border-t border-white/5 text-center">
                    <p className="text-gray-400 text-sm">
                      New to the game?{' '}
                      <Link to="/signup" className="text-white hover:text-primary font-bold transition-colors ml-1">Create Account</Link>
                    </p>
                  </div>
                </motion.div>
              )}
              ...
              {step === 2 && (
                ...
                >
                  ...
                  <h1 className="text-3xl font-extrabold mb-3 text-white">Admin Verification</h1>
                  <p className="text-gray-400 text-sm mb-10 leading-relaxed">
                    We've sent a 6-digit security code to your admin email address.
                  </p>
